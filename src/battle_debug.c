...
static const u8 sText_HoldEffectPearl[] = _("Pearl");
static const u8 sText_HoldEffectBigPearl[] = _("Big Pearl");
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_PEARL] = sText_HoldEffectPearl,
    [HOLD_EFFECT_BIG_PEARL] = sText_HoldEffectBigPearl,
};
static const u8 *GetHoldEffectName(u16 holdEffect)
{
