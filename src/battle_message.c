...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNACCURSEACTIVATES]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} put a curse on {B_DEF_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_PKMNMAKESGROUNDMISS]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} makes Ground moves miss with {B_DEF_ABILITY}!"), //not in gen 5+, ability popup
    ...
    [STRINGID_QUICKSTRIKE]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became fully charged due to its {B_ATK_ABILITY}!"),
    ...
    // custom
    [STRINGID_PKMNRAISEDSPATK]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} raised its Sp. Atk!"), //not in gen 5+, ability popup
    [STRINGID_ABILITYWEAKENEDCALMINGFLOWERSTATS]    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened {B_BUFF1} and {B_BUFF2}!\p"),
    [STRINGID_ABILITYWEAKENEDEVASIVEDANCESTATS]     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} lowered {B_BUFF1}!\p"),
    [STRINGID_ABILITYPESTILENCEACTIVATES]           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} infested {B_DEF_NAME_WITH_PREFIX2}!\p"), //not in gen 5+, ability popup
    [STRINGID_PKMNCUTSSPEEDWITH]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Speed!\p"),
