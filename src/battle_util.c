...
/* added for dynamic level scaling pokemon obedience */
#include "caps.h"
...
void PrepareStringBattle(u16 stringId, u32 battler)
{
    ...
    else if ((stringId == STRINGID_DEFENDERSSTATFELL || stringId == STRINGID_PKMNCUTSATTACKWITH || stringId == STRINGID_PKMNCUTSSPEEDWITH)
    ...
    case ABILITYEFFECT_ON_SWITCHIN:
        ...
        case ABILITY_SWEET_AROMA:
            if (!gSpecialStatuses[battler].switchInAbilityDone)
            {
                ...
                BattleScriptPushCursorAndCallback(BattleScript_SweetAromaActivates);
                effect++;
            }
            break;
    ...
    case ABILITYEFFECT_MOVE_END: // Think contact abilities.
        ...
        case ABILITY_BOUNCE_BACK:
             ...
             && IS_MOVE_PHYSICAL(gCurrentMove))
            {
                ...
                // gBattleMoveDamage = GetNonDynamaxMaxHP(gBattlerAttacker) / (B_ROUGH_SKIN_DMG >= GEN_4 ? 8 : 16);
                gBattleMoveDamage = max(1, (gBattleMoveDamage * 50 / 100));
        ...
        case ABILITY_CORNERED:
             ...
             && TARGET_TURN_DAMAGED)
            {
                gEffectBattler = gBattlerTarget;
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_CorneredActivates;
                effect++;
            }
            break;
        ...
        case ABILITY_PESTILENCE:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && !(gBattleMons[gBattlerTarget].status2 & STATUS2_WRAPPED))
             {
                ...
                BattleScriptPushCursor();
                gBattlescriptCurrInstr = BattleScript_AbilityPestilence;
...
u8 GetAttackerObedienceForAction()
{
    s32 rnd;
    s32 calc;
    u32 obedienceLevel = GetCurrentLevelCap();
    u8 levelReferenced;
...
u32 CalcSecondaryEffectChance(u32 battler, u32 battlerAbility, const struct AdditionalEffect *additionalEffect)
{
    ...
    bool8 hasGiftLuck = (battlerAbility == ABILITY_GIFT_LUCK);
