const struct TrainerMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_BLAZIKEN_5] = {
        ...
        .moves = {MOVE_DOUBLE_KICK, MOVE_PROTECT, MOVE_FIRE_PUNCH, MOVE_EMBER},
