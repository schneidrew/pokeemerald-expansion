...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_GUTS, ABILITY_CORNERED },
    ...
    [SPECIES_RATTATA_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_STRONG_JAW, ABILITY_CORNERED },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Rattata"),
        .cryId = CRY_RATTATA,
        .natDexNum = NATIONAL_DEX_RATTATA,
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_TECHNICIAN, ABILITY_QUICK_STRIKE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_DRY_SKIN, ABILITY_PESTILENCE },
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_NONE, ABILITY_PESTILENCE },
    #endif
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Paras"),
        .cryId = CRY_PARAS,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_TECHNICIAN, ABILITY_FATAL_STRIKE },
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_FATAL_STRIKE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIMBER, ABILITY_TECHNICIAN, ABILITY_FATAL_STRIKE },
    #else
        .abilities = { ABILITY_LIMBER, ABILITY_NONE, ABILITY_FATAL_STRIKE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_GLUTTONY, ABILITY_SWEET_AROMA },
        .bodyColor = BODY_COLOR_GREEN,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_PASTEL_VEIL, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ponyta"),
        .cryId = CRY_PONYTA,
        .natDexNum = NATIONAL_DEX_PONYTA,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_EARLY_BIRD, ABILITY_ON_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SLUSH_RUSH, ABILITY_THERMAL_EXCHANGE },
    #else
        .abilities = { ABILITY_THICK_FAT, ABILITY_SLUSH_RUSH, ABILITY_THERMAL_EXCHANGE },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_STENCH, ABILITY_STICKY_HOLD, ABILITY_TOXIC_OOZE },
        .bodyColor = BODY_COLOR_PURPLE,
