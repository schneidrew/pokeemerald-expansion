...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_NONE, ABILITY_DRAINER },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_NONE, ABILITY_TOXIC_SCALES },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_LUDICOLO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_RAIN_DISH, ABILITY_SOUND_SURFER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_FELINE_PROWESS },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_SWARM, ABILITY_BIOLESCENCE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        .baseHP        = 75,
        .baseAttack    = 95,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 83 : 55,
        .baseSpeed     = 75,
        .baseSpAttack  = 47,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 75,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_TINTED_LENS, ABILITY_VIRTUOSO },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_VIRTUOSO },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SWALOT] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_STICKY_HOLD, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_CLOUD_NINE, ABILITY_SOPRANO },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INFILTRATOR, ABILITY_ENSNARE},
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_CELESTIAL_BODY},
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_HYDRATION, ABILITY_EARTH_EATER },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_HYDRATION, ABILITY_EARTH_EATER },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
